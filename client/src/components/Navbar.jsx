...
const Navbar = () => {
 ...
 const logout =async ()=>{
  ...
  return (
    <div
      className="w-full flex justify-between items-center p-4 sm:p6 sm:px-24
    absolute top-0"
    >
      ...
      bg-black text-white relative group" >
        ...
        z-10 text-black rounded pt-10">
          <ul className="list-none m-0 p-2 bg-gray-100 text-sm">
            {!userData.isAccountVerified &&  <li onClick={sendVerificationOtp} className="py-1 px-2 hover:bg-gray-200 cursor-pointer whitespace-nowrap">
        Verify email
      </li>}
