      ...
      >
        ...
        rounded-full bg-[#333A5C]"
          ...
          <p
            ...
            className="mb-4 text-idigo-500 cursor-pointer"
          >
            {" "}
            Forget password ?
          </p>
        ...
        {state === "Sign Up" ? (
          <p className="text-sm text-gray-300 text-center mt-6">
            ...
            <span
              ...
              className="text-blue-400 font-semibold hover:underline hover:text-blue-300 transition-colors cursor-pointer"
            >
              Login here
            </span>
          </p>
